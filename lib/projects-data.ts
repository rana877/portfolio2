...
export const projects: Project[] = [
  {
    ...
    image: "https://i.postimg.cc/kg0XBg1N/airane-3.png",
    gallery: [
      "https://i.postimg.cc/kg0XBg1N/airane-3.png",
      "https://i.postimg.cc/50xJCYwd/ariane-invoice-generate.png",
      "https://i.postimg.cc/sDtRJ0p8/ariane-email-reminder.png",
    ],
...
└── Stage 4: Payment Monitoring & Intelligent Follow-ups`,
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/Kc3ydNpK/sign-up.png",
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/VN4CP160/amanda-workflow.jpg",
...
└── Notification & Monitoring System`,
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/4x0SXCSc/HRM.png",
...
└── n8n Webhook Layer
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/QxdDt30F/CRM.png",
...
└── n8n Webhook API Layer
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/JhD6YTKy/onboarding-agent.png",
...
└── n8n Orchestrator
  ...
  },
  {
    ...
    shortDescription: "Automated leave request processing, multi-level manager approvals, and leave balance tracking system.",
    image: "https://i.postimg.cc/kgkDK4HX/leave-system.png",
    tags: ["n8n", "Leave Management", "HR Automation"],
    impact: "Automated leave request & approval workflow",
    role: "Automation Architect",
    platform: "n8n + Slack / Email + Database",
    category: "HR Operations • Leave Management • Workflow Automation",
    year: "2025",
    status: "in-production",
    stack: ["n8n", "Slack API", "Postgres", "SendGrid"],
    problem:
      "Manual leave requests via email or paper forms caused delays in approval routing, incorrect leave balance tracking, and high HR overhead.",
    approach:
      "Designed an automated n8n workflow system that receives leave requests, auto-checks remaining leave balance, triggers interactive manager approval notifications, and syncs status real-time.",
    overview:
      "An automated Leave Management System built in n8n to streamline employee leave applications, supervisor approvals, and automated quota deductions.",
    metrics: [
      { label: "Approval Time", value: "< 5 Mins" },
      { label: "Automation Rate", value: "100%" },
      { label: "Integrations", value: "Slack, Email, Postgres" },
    ],
    whyItMatters: [
      "Eliminates manual HR processing for routine leave requests",
      "Ensures transparent, real-time balance calculations",
      "Accelerates manager approvals via interactive notifications",
    ],
  },
  {
    slug: "employee-attendance-system",
    title: "Employee Attendance Management System",
    shortDescription: "Automated attendance tracking, shift logging, check-in validation, and automated reporting system.",
    image: "https://i.postimg.cc/P5mNbhn5/attendence-system.png",
    tags: ["n8n", "Attendance Tracking", "HR Automation"],
    impact: "Real-time attendance & shift tracking",
    role: "Automation Engineer",
    platform: "n8n + Biometric API + HR Database",
    category: "HR Operations • Attendance Management • System Integration",
    year: "2025",
    status: "in-production",
    stack: ["n8n", "REST API", "Postgres", "Automated Alerts"],
    problem:
      "Disparate check-in sources and biometric hardware led to errors in monthly attendance consolidation, manual overtime calculations, and delayed payroll processing.",
    approach:
      "Built an automated integration pipeline in n8n to ingest biometric and digital check-ins, validate shifts against roster schedules, flag anomalies, and generate daily attendance summaries.",
    overview:
      "A comprehensive Employee Attendance Management System built in n8n for real-time tracking, anomaly detection, and automated payroll-ready attendance reports.",
    metrics: [
      { label: "Daily Logs Processed", value: "1000+" },
      { label: "Error Reduction", value: "99%" },
      { label: "Report Generation", value: "Automated" },
    ],
    whyItMatters: [
      "Provides HR with real-time visibility into workforce attendance",
      "Automates shift validation and exception flagging",
      "Prepares accurate data directly for monthly payroll runs",
    ],
  },
  {
    ...
    image: "https://i.postimg.cc/6q7D89rL/content.png",
    gallery: [
      "https://i.postimg.cc/6q7D89rL/content.png",
      "https://i.postimg.cc/x1GBJpzK/content2.png",
      "https://i.postimg.cc/mhf6h7Zn/content3.png",
      "https://i.postimg.cc/HnsbzxZt/content4.png",
      "https://i.postimg.cc/SNRWznYZ/content5.png",
      "https://i.postimg.cc/mrYMGMKR/content6.png",
    ],
...
└── Stage 5: Automatic Template Generation & Calendar Creation`,
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/qBjRnQ8H/GTM.png",
    gallery: [
      "https://i.postimg.cc/qBjRnQ8H/GTM.png",
      "https://i.postimg.cc/3rnRp9gY/GTM2.png",
    ],
